        ...
        <div className="flex justify-between h-[90px]">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-2">
              <Link href="/en" className={`px-2 py-1 text-sm ${locale === 'en' ? 'bg-[#0f1e32] text-white' : 'text-gray-600 hover:text-[#0f1e32]'} rounded`}>
                EN
              </Link>
              <Link href="/fr" className={`px-2 py-1 text-sm ${locale === 'fr' ? 'bg-[#0f1e32] text-white' : 'text-gray-600 hover:text-[#0f1e32]'} rounded`}>
                FR
              </Link>
            </div>
          </div>
